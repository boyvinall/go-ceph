...
// checks if the RbdImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RbdImage{}

// RbdImage struct for RbdImage
type RbdImage struct {
	...
	// 
	Snapshots []RbdImageSnapshotsInner `json:"snapshots,omitempty"`
	// 
	TotalDiskUsage *float32 `json:"total_disk_usage,omitempty"`
	// 
	DiskUsage *int32 `json:"disk_usage,omitempty"`
	// 
	Configuration []RbdImageConfigurationInner `json:"configuration,omitempty"`
}
...
func (o *RbdImage) SetDataPoolNil() {
	o.DataPool.Set(nil)
}
...
func (o *RbdImage) GetSnapshots() []RbdImageSnapshotsInner {
	if o == nil || IsNil(o.Snapshots) {
		var ret []RbdImageSnapshotsInner
		return ret
	}
	return o.Snapshots
}
...
// SetSnapshots gets a reference to the given []RbdImageSnapshotsInner and assigns it to the Snapshots field.
...
func (o *RbdImage) GetConfiguration() []RbdImageConfigurationInner {
	if o == nil || IsNil(o.Configuration) {
		var ret []RbdImageConfigurationInner
		return ret
	}
...
// SetConfiguration gets a reference to the given []RbdImageConfigurationInner and assigns it to the Configuration field.
func (o *RbdImage) SetConfiguration(v []RbdImageConfigurationInner) {
	o.Configuration = v
}

func (o RbdImage) MarshalJSON() ([]byte, error) {
...
func (o RbdImage) ToMap() (map[string]interface{}, error) {
...
type NullableRbdImage struct {
	value *RbdImage
	isSet bool
}

func (v NullableRbdImage) Get() *RbdImage {
	return v.value
}

func (v *NullableRbdImage) Set(val *RbdImage) {
	v.value = val
	v.isSet = true
}

func (v NullableRbdImage) IsSet() bool {
	return v.isSet
}

func (v *NullableRbdImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRbdImage(val *RbdImage) *NullableRbdImage {
	return &NullableRbdImage{value: val, isSet: true}
}

func (v NullableRbdImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRbdImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
